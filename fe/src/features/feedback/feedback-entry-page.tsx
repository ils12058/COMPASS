...
export function FeedbackEntryPage() {
  ...
  return (
    <section aria-labelledby="feedback-entry-heading">
      <FeedbackPageHeading headingId="feedback-entry-heading" eyebrow="Guidance Services" title="Feedback" description="Choose a response instrument or review submitted responses available to your role." />
      {access.canSubmitCustomerFeedback || access.canSubmitCsm ? (
        <div className="mt-7">
          ...
          <ul className="mt-4 divide-y divide-border border-y border-border">
            {access.canSubmitCustomerFeedback ? <li className="py-5"><Link href="/portal/feedback/customer-feedback" className="font-semibold text-brand underline hover:text-brand-strong focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus">Customer Feedback Form</Link><p className="mt-1 text-sm text-muted">Share feedback on your Guidance and Testing Affairs Office service experience.</p></li> : null}
