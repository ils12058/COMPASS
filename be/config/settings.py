...
COUNSELING_CONTEXT_PRE_APPOINTMENT_HOURS = env_int(
    "COUNSELING_CONTEXT_PRE_APPOINTMENT_HOURS", 24
)
COUNSELING_CONTEXT_UNCOMPLETED_GRACE_HOURS = env_int(
    "COUNSELING_CONTEXT_UNCOMPLETED_GRACE_HOURS", 24
)
COUNSELING_CONTEXT_POST_ENCOUNTER_DAYS = env_int(
    "COUNSELING_CONTEXT_POST_ENCOUNTER_DAYS", 7
)
